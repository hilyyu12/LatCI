    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">ADMIN - MATERIAL DESIGN</a>
            </div>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>Hilyyu</b> commented your post</h4>
                                                <p>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>Hilyyu</b> updated status</h4>
                                                <p>
                                                    <i class="material-icons">access_time</i> 3 hours ago
                                                </p>
                                            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email">abiyyu_hilmi_26rpl@student.smktelkom-mlg.sch.id</div>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 - 2019 <a href="javascript:void(0);">Admin - Material Design</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 2.0.0
                </div>
